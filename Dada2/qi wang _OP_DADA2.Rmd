...
path = "/Users/if-mcs-1247c/Desktop/Osteoporosis/Quwang\ _dataset/Fastq-files" 
list.files(path)
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, maxN=0, maxEE=c(2,2), truncLen= c(240,240), truncQ=2, rm.phix=TRUE, trimLeft = c(17,21), compress=TRUE, multithread=TRUE )
head(out)
...
```{r message=FALSE, warning=FALSE, paged.print=FALSE, cache=TRUE, echo = TRUE}
saveRDS(seqtab.nochim3, "/Users/if-mcs-1247c/Desktop/Osteoporosis/seqtabnochim_qi.rds")
saveRDS(taxa_rdp, "/Users/if-mcs-1247c/Desktop/Osteoporosis/taxa_qirdb.rds")
View(otu_table(seqtab.nochim3, taxa_are_rows = TRUE))
```